# -*- coding: utf-8 -*-
# @Time : 2020/11/29 22:10
# @Author : Jason
# @File : data_Refreshing北京.py
# @Software: PyCharm
...
df = drm.batch_process_csv(r'C:\Users\dcdn\Desktop\北京市')

# output first round, assign their city code manually
df.to_csv('C:/Users/dcdn/Desktop/北京_Result_raw.csv', encoding="utf_8_sig")
...
new_df = pd.read_csv('C:/Users/dcdn/Desktop/北京_Result_raw.csv')
...
# # extra operation, makeup operation
# df = pd.read_csv('C:/Users/dcdn/Desktop/北京_Result_Finished.csv')
# df['house_num'] = df['house_num'] * 10000
# df.to_csv('C:/Users/dcdn/Desktop/北京_Result_Finished1.csv', encoding="utf_8_sig")

# then the data is complete, output get csv file or excel file
new_df.to_csv('C:/Users/dcdn/Desktop/北京_Result_Finished.csv', encoding="utf_8_sig")
