# -*- coding: utf-8 -*-
# @Time : 2020/11/30 19:59 
# @Author : Jason
# @File : data_Refreshing新疆.py 
# @Software: PyCharm
...
df = drm.batch_process_csv(r'C:\Users\dcdn\Desktop\新疆维吾尔自治区')

# output first round, assign their city code manually
df.to_csv('C:/Users/dcdn/Desktop/新疆_Result_raw.csv', encoding="utf_8_sig")
...
# new_df = pd.read_csv('C:/Users/dcdn/Desktop/新疆_Result_raw.csv')
#
...
# new_df.to_csv('C:/Users/dcdn/Desktop/新疆_Result_Finished.csv', encoding="utf_8_sig")
