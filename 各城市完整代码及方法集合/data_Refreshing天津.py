...
df = drm.batch_process_csv(r'C:\Users\dcdn\Desktop\天津市')

# output first round, assign their city code manually
df.to_csv('C:/Users/dcdn/Desktop/天津_Result_raw.csv', encoding="utf_8_sig")
...
# new_df = pd.read_csv('C:/Users/dcdn/Desktop/天津_Result_raw.csv')
#
...
# new_df.to_csv('C:/Users/dcdn/Desktop/天津_Result_Finished.csv', encoding="utf_8_sig")
