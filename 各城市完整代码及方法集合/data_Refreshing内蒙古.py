# -*- coding: utf-8 -*-
# @Time : 2020/11/30 20:04 
# @Author : Jason
# @File : data_Refreshing内蒙古.py 
# @Software: PyCharm
...
df = drm.batch_process_csv(r'C:\Users\dcdn\Desktop\内蒙古自治区')

# output first round, assign their city code manually
df.to_csv('C:/Users/dcdn/Desktop/内蒙古_Result_raw.csv', encoding="utf_8_sig")
...
# new_df = pd.read_csv('C:/Users/dcdn/Desktop/内蒙古_Result_raw.csv')
#
...
# new_df.to_csv('C:/Users/dcdn/Desktop/内蒙古_Result_Finished.csv', encoding="utf_8_sig")
